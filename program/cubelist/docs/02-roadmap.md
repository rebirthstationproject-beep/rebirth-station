...
>
> 본 로드맵은 cron 자동 진행 사이클 #1~#25로 **실제 진행 완료** 되었으며, 일부 세부 결정은
> 진행 중 변경되었습니다. 권위 소스는 다음으로 이관:
>
> - **실 산출**: `CHANGELOG.md` v0.1.0 (cron #25 작성)
> - **현재 마일스톤 상태**: `STATE.md` 마일스톤 진행 보드
> - **영구 결정**: `docs/05-decisions.md` (D-01 두 트랙 분리, D-04~05 PC UI 위치/기술 등)
> - **wire 호환**: `docs/06-wire-compat.md`
> - **베타 체크**: `docs/07-release-checklist.md`
>
> 본 로드맵 본문의 일부 가정 (예: "PC 메인 격상", "32일 추정", "잔류물 회수") 은
> 실 진행과 다르게 결정되었습니다. **D-01 결정** = 모바일 PWA + PC 두 트랙 분리, 각자 독립
> 발전 (`docs/05-decisions.md`). 본 문서는 historical 로 보존.
