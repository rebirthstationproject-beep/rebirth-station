...
> **정정 (2026-07-06)**: 주소모아 폐기 확정(2026-07-03)으로 본 문서 M-C의 "주소모아 = 개발 베드에서 검증 후 케이링크로 복제" 전제가 소멸.
> 주소모아 /cube-board noindex 베타에 투입된 자산(cube-format 최소 포팅 + 렌더 + link 실행)은 케이링크.com 재오픈 시 **직행 이식**한다.
> M-C 1항의 "주소모아 링크 큐브 교체"는 케이링크 대상으로 대체. 이하 본문은 historical record로 보존.
